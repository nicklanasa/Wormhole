...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods/FZImageUtilCategory.framework"
  install_framework "Pods/ImgurAnonymousAPIClient.framework"
  ...
  install_framework "Pods/RedditKit.framework"
